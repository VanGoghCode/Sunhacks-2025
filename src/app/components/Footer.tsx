      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Loop IT</h3>
            <p className="text-gray-400 mb-4 max-w-md">
              Building a more sustainable future through device reuse and responsible recycling.
            </p>
            <p className="text-sm text-gray-500 mb-4">
              © 2024 Loop IT. All rights reserved.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/specifications" className="text-gray-400 hover:text-white transition-colors">Specifications</a></li>
