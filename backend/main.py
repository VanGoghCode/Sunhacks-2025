...
app = FastAPI(
    title="Demo Wipe Assistant API",
    description="FastAPI backend for generating demo wipe scripts and analyzing wipe logs",
    version="1.0.0"
)
...
async def root():
    ...
    return {"message": "Demo Wipe Assistant API is running"}
